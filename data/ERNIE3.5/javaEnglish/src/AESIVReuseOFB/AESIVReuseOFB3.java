...
public class AESIVReuseOFB3 {
    ...
    private static final String KEY = "ThisIsASecretKey"; // Replace with your own secret key
    private static final String IV = "ThisIsAnIV"; // Replace with your own initialization vector
